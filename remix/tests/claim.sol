...
contract BuyTokenClaim is Owned {
    ...
    constructor(){
        //Buy
        address _token_address = address(0x6195af222a72594386b8B77ae63d07E945a79E45);
        ...
        //Referral
        claim_referral_bonus = 300000;
        buy_referral_bonus = 500;
        ...
        claim_address = address(0xe6780E6946de4D36bb59F700C991FbE4c1fd98d4);
    }
